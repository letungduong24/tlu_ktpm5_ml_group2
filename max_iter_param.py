...
# Danh sách các giá trị max_iter để thử nghiệm
max_iter_list = [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000]
results = []

# Vòng lặp qua các giá trị max_iter
for max_iter in max_iter_list:
    mlp = MLPRegressor(
        hidden_layer_sizes=(350,400),  # Bạn có thể thay đổi cấu trúc lớp ẩn ở đây nếu muốn
        max_iter=max_iter,
        early_stopping=True,
...
st.title("Kết quả thử nghiệm MLPRegressor với max_iter")
